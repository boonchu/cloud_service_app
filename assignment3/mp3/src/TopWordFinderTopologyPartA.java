...
public class TopWordFinderTopologyPartA {
  ...
  public static void main(String[] args) throws Exception {
    ...
    When connecting the component in the topology (using builder.setSpout() and builder.setBolt()),
    make sure when connecting components together, using the functions setBolt(name,…) and setSpout(name,…),
